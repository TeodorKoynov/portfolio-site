    ...
    >
        ...
        <div className={"mt-1 "}>
            ...
            <div className={"mt-7 flex justify-between items-center gap-1"}>
                ...
                <Image className={"w-10 h-10 rounded-full object-cover"} width={120} height={120} src={image} alt={`feedback-by-${name}`} />
            </div>
        </div>
    </motion.div>
)
        ...
        <div className={"mt-12 bg-black-100 rounded-[20px]"}>
            <div className={"sm:px-16 px-6 sm:py-16 py-10 bg-tertiary rounded-2xl min-h-[300px]"}>
                <motion.div variants={textVariant()}>
                    <p className={"sm:text-[18px] text-[14px] text-secondary uppercase tracking-wider"}>What others
                        say</p>
